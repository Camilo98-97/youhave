! function(e, t) {
    ...
    function n() {
        ...
        a(u), c(), l();
        var f = w();
        u.timer && (f.timeout = setTimeout(function() { r(), "function" == typeof u.callback && u.callback() }, u.timer));
        var y, C = function(t) {
                var n = t || e.event,
        ...
        u.reverseButtons && k.parentNode.insertBefore(B, k), n(-1, 1), d = e.onkeydown, e.onkeydown = i, u.buttonsStyling && (k.style.borderLeftColor = u.confirmButtonColor, k.style.borderRightColor = u.confirmButtonColor), e.swal.toggleLoading = function() { k.disabled = !k.disabled, B.disabled = !B.disabled }, e.swal.enableButtons = function() { k.disabled = !1, B.disabled = !1 }, e.swal.disableButtons = function() { k.disabled = !0, B.disabled = !0 }, swal.enableButtons(), e.onfocus = function() { e.setTimeout(function() { void 0 !== g && (g.focus(), g = void 0) }, 0) }
    }
    ...
    function s(e, t) { for (var n in t) t.hasOwnProperty(n) && (e[n] = t[n]); return e }

    function l() {
        var e = w();
        O(v(), 10), S(e), C(e, "show-sweet-alert"), h(e, "hide-sweet-alert"), u = t.activeElement, setTimeout(function() { C(e, "visible") }, 500)
    }
    ...
    e.swalClasses = { modal: "sweet-alert", overlay: "sweet-overlay", confirm: "sweet-confirm", cancel: "sweet-cancel" };
    var u, m, d, g, f = "sweet-alert-mediaquery",
        ...
        w = function() { return t.querySelector("." + e.swalClasses.modal) },
        v = function() { return t.querySelector("." + e.swalClasses.overlay) },
        b = function(e, t) { return new RegExp(" " + t + " ").test(" " + e.className + " ") },
        C = function(e, t) { t && !b(e, t) && (e.className += " " + t) },
        h = function(e, t) {
        ...
        k = function(e) { var n = t.createElement("div"); return n.appendChild(t.createTextNode(e)), n.innerHTML },
        B = function(e) { e.style.opacity = "", e.style.display = "block" },
        S = function(e) { if (e && !e.length) return B(e); for (var t = 0; t < e.length; ++t) B(e[t]) },
        x = function(e) { e.style.opacity = "", e.style.display = "none" },
        E = function(e) { if (e && !e.length) return x(e); for (var t = 0; t < e.length; ++t) x(e[t]) },
        ...
        O = function(e, t) {
            if (+e.style.opacity < 1) {
                ...
                var n = +new Date,
                    a = function() { e.style.opacity = +e.style.opacity + (new Date - n) / 100, n = +new Date, +e.style.opacity < 1 && setTimeout(a, t) };
                a()
            }
        ...
        M = function(t) { "function" == typeof t.stopPropagation ? (t.stopPropagation(), t.preventDefault()) : e.event && e.event.hasOwnProperty("cancelBubble") && (e.event.cancelBubble = !0) };
    e.sweetAlert = e.swal = function() {
            var e = arguments,
                t = w();
            if (null !== t) b(t, "visible") && i(), n.apply(this, e);
            else var a = setInterval(function() { null !== w() && (clearInterval(a), n.apply(this, e)) }, 100)
        }, e.sweetAlert.closeModal = e.swal.closeModal = function() { r() }, e.sweetAlert.clickConfirm = e.swal.clickConfirm = function() {
            var t = w(),
