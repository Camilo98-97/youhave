                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="mdl-data-table__cell--non-numeric">
                                            <?=$valor['nombreCliente'] ," ", $valor['apellidoCliente']?></td>
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="php/clientdelete.php?idCliente=<?=$valor['idCliente']?>">Eliminar</a>
                                                    </li>

                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="php/clientedit.php?idCliente=<?=$valor['idCliente']?>">Editar</a>
                                                    </li>
